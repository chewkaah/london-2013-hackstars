...
<div id="top">
	...
	<div class="container">
		...
		<div id="list">
			...
			<?php
		 		$faces = array();
		 		$faces[] = array('name' => 'Brad Thorson','title' => '','email' => 'bbthorson@gmail.com','phone' => '','linkedin' => 'http://www.linkedin.com/in/bbthorson','twitter' => '@bbthorson','img' => array('src' => 'img/thorson.jpg','class' => 'height-150 top-5 left-0'));
